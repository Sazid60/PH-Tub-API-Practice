...
const displayNav = (buttons) => {
    buttons.forEach(button => {
        ...
        btnCategory.className = 'bg-slate-300 border border-zinc-500 rounded-xl py-3 px-8 text-xl font-semibold';
        btnCategory.addEventListener('click', () => fetchDataCategories(button.category_id))
    ...
    <div class="card-body p-3">
        <div class="flex justify-around space-x-3">
            ...
            <div>
                ...
                <p id="" class="text-sm">${card.authors[0].profile_name} <span class="text-lg"> <i
                            class="fa-solid fa-certificate text-blue-600"></i></span></p>
